...
export function isReadableLocationLabel(value?: string | null): boolean {
...
export function getBestLocationLabel(mainSuggestion?: any, city?: string, country?: string): string {
  const candidates = [
    mainSuggestion?.name,
