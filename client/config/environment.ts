...
export const FIREBASE_CONFIG = {
  apiKey: getEnvVar('EXPO_PUBLIC_FIREBASE_API_KEY', 'SET_IN_ENV'),
  authDomain: getEnvVar('EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN', 'SET_IN_ENV'),
  projectId: getEnvVar('EXPO_PUBLIC_FIREBASE_PROJECT_ID', 'SET_IN_ENV'),
  storageBucket: getEnvVar('EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET', 'SET_IN_ENV'),
  messagingSenderId: getEnvVar('EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID', 'SET_IN_ENV'),
  appId: getEnvVar('EXPO_PUBLIC_FIREBASE_APP_ID', 'SET_IN_ENV'),
  measurementId: getEnvVar('EXPO_PUBLIC_FIREBASE_MEASUREMENT_ID', 'SET_IN_ENV')
} as const;
...
const EXPO_GOOGLE_MAPS_KEY = getEnvVar('EXPO_PUBLIC_GOOGLE_MAPS_API_KEY', 'SET_IN_ENV');
